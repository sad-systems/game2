...
module.exports = {
    ...
    create: function(game, playerInstance, mapManager, menuScene) {
        ...
        */
        //--- Game mobilepad:
        var mp = mobilepadButtons.create({game:game, buttons:{
            a:      {
                        onDown:playerInstance.actionA.bind(playerInstance)
                    },
            b:      {
        ...
        var tb = toolButtons.create({game:game, x:10, y:10, buttons:{
            ...
            Gamepad:   { state:0, onDown:function(o){ o.setState(!o.state); mp.invisibleAlpha = mp.invisibleAlpha ?  0 : 0.4 ; mp.setButtons(); } },
            //{ state:gp.groupButtons.visible, onDown:function(o){ gp.toggleWithInverse(); o.setState(gp.groupButtons.visible); } },
