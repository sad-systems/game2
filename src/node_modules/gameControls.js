...
module.exports = {
    ...
    create: function(game, playerInstance, mapManager, menuScene) {
        ...
        //--- Arsenal buttons:
        var ab = arsenalButtons.create({game:game, x:10, y:10, leftSide:false, buttons:{
            0: { state:0, onDown:function(o){ o.setState(!o.state); console.log('0: ' + o.state); } },
            1: { state:0, onDown:function(o){ o.setState(!o.state); console.log('1: ' + o.state); } },
            2:  { state:0, onDown:function(o){ o.setState(!o.state); console.log('2: ' + o.state); } },
            Star:  {}
        }});
    ...
    // Phaser.Events.onAddedToGroup.add(function(g){ console.log(g); },this,0);
        ...
        this.group.add(ab.groupToolsButtons);
        this.group.add(tb.groupToolsButtons);
