...
module.exports = {
    ...
    create: function(game, playerInstance, mapManager, menuScene) {
        ...
        var ab = arsenalButtons.create({game:game, x:10, y:10, leftSide:false, buttons:{
            Music: { state:0, onDown:function(o){ o.setState(!o.state); console.log('0: ' + o.state); } },
            Sound: { state:0, onDown:function(o){ o.setState(!o.state); console.log('1: ' + o.state); } },
            Menu:  { state:0, onDown:function(o){ o.setState(!o.state); console.log('2: ' + o.state); } },
            Settings:  {}
        }});
        //--------------------------------        
